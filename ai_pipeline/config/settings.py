...
MASK_SIGNATURE_DIR = os.path.join(
    DATA_DIR, 'output', 'output_segmentation', 'masks_signature'
)
MASK_STAMP_DIR = os.path.join(
    DATA_DIR, 'output', 'output_segmentation', 'masks_stamp'
)
